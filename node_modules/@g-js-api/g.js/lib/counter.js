...
let counter = (num = 0, use_id = false, persistent = false, timer = false) => {
    let id = use_id ? num : unknown_g().value;
    if (num != 0 && !use_id) {
        if (!persistent) {
            $.add(object({
                OBJ_ID: 1817,
    ...
    let exports = {
        ...
        add: (amount) => {
            if (typeof amount == 'number') {
                ...
                $.add(item_edit(amount.item, NONE, id, exports.type, NONE, exports.type, ADD));
            }
        },
        set: (amount) => {
            if (typeof amount == 'number') {
                ...
                $.add(item_edit(NONE, amount.item, id, NONE, amount.type, exports.type, EQ));
            }
        },
        subtract: (amount) => {
            if (typeof amount == 'number') {
                ...
                $.add(item_edit(amount.item, NONE, id, exports.type, NONE, exports.type, SUB));
            }
        },
        multiply: (amount) => {
            if (typeof amount == 'number') {
                ...
                $.add(item_edit(amount.item, NONE, id, exports.type, NONE, exports.type, MUL));
            }
        },
        divide: (amount) => {
            if (typeof amount == 'number') {
                ...
                $.add(item_edit(amount.item, NONE, id, exports.type, NONE, exports.type, DIV));
            }
        },
        display: (x, y) =>
            $.add(object({
        ...
        to_obj: () => {
            let or = object({
                ...
                ITEM: id,
                COLOR: color(1),
                ...(exports.type == TIMER ? {TIME_COUNTER: 1} : {}),
            });
            return or;
        },
        if_is: (comparison, other, trig_func, activate = true) => {
            $.add(object({
                OBJ_ID: 1811,
                TARGET: trig_func,
                COUNT: other,
        ...
        copy_to: (item) => {
            $.add(item_edit(NONE, id, item.item, NONE, item.type, exports.type, EQ));
        },
        clone: () => {
